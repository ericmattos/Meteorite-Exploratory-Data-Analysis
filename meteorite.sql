...
-- Our first step is to determine how many meteorites there are in the data set

SELECT COUNT(*)
FROM meteorite_data;

-- Suppose we want to know how many of these meteorites are missing their mass. We can find out using
...
-- Next, let us classify the meteorites based on their mass, labeling them as "heavy" if their mass is above the average and as "light" if it is below the average.
...
-- This method can be easily generalised for the n-th oldest meteorite by replacing 'LIMIT 2' by 'LIMIT n'.
